...
class WordCountTest(unittest.TestCase):
    ...
    def test_count_one_of_each(self):
        self.assertEqual(word_count("one of each"), {"one": 1, "of": 1, "each": 1})
    ...
    def test_cramped_list(self):
        self.assertEqual(word_count("one,two,three"), {"one": 1, "two": 1, "three": 1})
    ...
    def test_normalize_case(self):
        self.assertEqual(word_count("go Go GO Stop stop"), {"go": 3, "stop": 2})
