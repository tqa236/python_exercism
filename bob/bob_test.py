...
class BobTest(unittest.TestCase):
    ...
    def test_asking_a_question(self):
        self.assertEqual(hey("Does this cryogenic chamber make me look fat?"), "Sure.")
    ...
    def test_forceful_question(self):
        self.assertEqual(
            hey("WHAT THE HELL WERE YOU THINKING?"), "Calm down, I know what I'm doing!"
        )
    ...
    def test_statement_containing_question_mark(self):
        self.assertEqual(hey("Ending with ? means a question."), "Whatever.")

    def test_non_letters_with_question(self):
        self.assertEqual(hey(":) ?"), "Sure.")

    def test_prattling_on(self):
        self.assertEqual(hey("Wait! Hang on. Are you going to be OK?"), "Sure.")
    ...
    def test_ending_with_whitespace(self):
        self.assertEqual(hey("Okay if like my  spacebar  quite a bit?   "), "Sure.")
