...
def find_column_neighbor_points(point, point_lists):
...
def check_complete_horizontal_line(point, other, ascii_diagram):
...
def check_complete_vertical_line(point, other, ascii_diagram):
