...
class KindergartenGardenTest(unittest.TestCase):
    ...
    def test_garden_with_two_students(self):
        garden = Garden("VVCG\nVVRC")
        self.assertEqual(garden.plants("Bob"), "Clover Grass Radishes Clover".split())
    ...
    def test_full_garden(self):
        ...
        self.assertEqual(
            garden.plants("Alice"), "Violets Radishes Violets Radishes".split()
        )
        self.assertEqual(garden.plants("Bob"), "Clover Grass Clover Clover".split())
        self.assertEqual(garden.plants("Kincaid"), "Grass Clover Clover Grass".split())
        self.assertEqual(garden.plants("Larry"), "Grass Violets Clover Violets".split())
    ...
    def test_disordered_test(self):
        ...
        self.assertEqual(
            garden.plants("Patricia"), "Violets Clover Radishes Violets".split()
        )
        self.assertEqual(
