...
def tag_special_ingredients(dish):
    ...
    Return the dish nsets_categories_dataame followed by the `set` of ingredients that require a special note on the dish description.
